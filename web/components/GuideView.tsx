...
const INDICATORS: Doc[] = [
  ...
  },
  {
    ...
    measures: { ja: "上昇している銘柄がどれだけ「広く」多いか。一部の大型株だけでなく市場全体が上がっているかを見る。", en: "How broadly stocks are advancing — whether the whole market, not just a few large caps, is rising." },
  ...
  },
  {
    ...
    dim: { ja: "ブレッドス（市場の幅）", en: "Breadth" },
    measures: { ja: "52週高値をつけた銘柄と安値をつけた銘柄の差。相場の「地力」の強さ。", en: "The gap between stocks hitting 52-week highs and those hitting lows — the market's underlying strength." },
